...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BOOL isAlreadyLoggedIn = [[NSUserDefaults standardUserDefaults] boolForKey:@"IsAlreadyLoggedIn"];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.directi.Twitter" in the application's documents directory.
